        ...
        <div>
            ...
            <div className='container p-3 row row-cols-1 row-cols-md-2 row-cols-lg-3'>
                <div className='col p-3'>
                    <h3 className='fw-bold text-center text-success'>How does React work?</h3>
                    <p>React uses JSX to execute code. ReactJS divides the UI into isolated reusable pieces of code known as <strong>components</strong>. React components work similarly to JavaScript functions as they accept arbitrary inputs called properties or <strong>props</strong>. Thus React has made it possible to have as many components as necessary without cluttering the code. Behind the scene, React goes through its <strong>virtual DOM</strong> ,creates a list of those changes that need to be made to the actual DOM and then does it all in one single process. This helps to make websites efficient.</p>
                </div>
                <div className='col p-3'>
                    <h3 className='fw-bold text-center text-success'>What is the difference between Props and State?</h3>
                ...
                <div className='col p-3'>
                    <h3 className='fw-bold text-center text-success'>What is the use of useEffect other than loading data?</h3>
